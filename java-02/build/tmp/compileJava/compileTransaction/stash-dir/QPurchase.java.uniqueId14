...
public class QPurchase extends EntityPathBase<Purchase> {
    ...
    private static final long serialVersionUID = -1000985484L;
    ...
    public final EnumPath<com.sparta.java_02.common.enums.PurchaseStatus> status = createEnum("status", com.sparta.java_02.common.enums.PurchaseStatus.class);
    ...
    public final com.sparta.java_02.domain.user.entity.QUser user;
    ...
    public QPurchase(Class<? extends Purchase> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.sparta.java_02.domain.user.entity.QUser(forProperty("user")) : null;
    }
