...
public class QPurchaseProduct extends EntityPathBase<PurchaseProduct> {
    ...
    private static final long serialVersionUID = -445706789L;
    ...
    public final com.sparta.java_02.domain.product.entity.QProduct product;
    ...
    public QPurchaseProduct(Class<? extends PurchaseProduct> type, PathMetadata metadata, PathInits inits) {
        ...
        this.product = inits.isInitialized("product") ? new com.sparta.java_02.domain.product.entity.QProduct(forProperty("product")) : null;
